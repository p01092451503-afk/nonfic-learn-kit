...
const DashboardLayout = ({ children, role = "student" }: DashboardLayoutProps) => {
  ...
  const roleLabel = role === "admin" ? "관리자" : role === "teacher" ? "강사" : "학습자";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <div className="p-6 flex items-center justify-between">
          <div>
            <h1 className="font-display text-lg tracking-wider text-sidebar-primary">
              NONFICTION
            </h1>
        ...
        <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-md border-b border-border h-16 flex items-center px-6 gap-4">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-border">
            ...
            <div className="hidden sm:block">
              <p className="text-sm font-medium text-foreground leading-none">사용자</p>
